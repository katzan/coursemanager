...
privileged aspect StudentDataOnDemand_Roo_DataOnDemand {
    ...
    public void StudentDataOnDemand.setAddresLine2(Student obj, int index) {
        String addresLine2 = "addresLine2_" + index;
        if (addresLine2.length() > 60) {
            addresLine2 = addresLine2.substring(0, 60);
        }
        obj.setAddresLine2(addresLine2);
    }
